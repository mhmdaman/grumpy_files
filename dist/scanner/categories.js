...
exports.EXTENSION_MAP = exports.DEFAULT_BUNDLE_EXTENSIONS = void 0;
exports.isBundleDirectory = isBundleDirectory;
...
exports.DEFAULT_BUNDLE_EXTENSIONS = ['app', 'bundle', 'framework', 'plugin', 'kext', 'xpc'];
/**
 * Check whether a directory name matches a package/bundle extension (e.g. "VSCode.app").
 */
function isBundleDirectory(dirName, bundleExtensions = exports.DEFAULT_BUNDLE_EXTENSIONS) {
...
function getCategory(extension) {
    ...
    if (exports.DEFAULT_BUNDLE_EXTENSIONS.includes(lowerExt)) {
        return 'Applications';
    }
